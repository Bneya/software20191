...
class CampusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campus" do
    assert_difference('Campus.count') do
      post campuses_url, params: { campus: { description: @campus.description, location_map: @campus.location_map, name: @campus.name } }
    end
  ...
  test "should update campus" do
    patch campus_url(@campus), params: { campus: { description: @campus.description, location_map: @campus.location_map, name: @campus.name } }
