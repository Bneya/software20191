...
ActiveRecord::Schema.define(version: 20190615175257) do
  ...
  create_table "classroomcomments", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "eventpostcomments", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "eventposts", force: :cascade do |t|
    ...
    t.index ["cached_votes_down"], name: "index_eventposts_on_cached_votes_down"
    t.index ["cached_votes_score"], name: "index_eventposts_on_cached_votes_score"
    t.index ["cached_votes_total"], name: "index_eventposts_on_cached_votes_total"
    t.index ["cached_votes_up"], name: "index_eventposts_on_cached_votes_up"
  end
